...
rel=stylesheet type=text/css href="../../../../../../每日文件/U4/U4=Day12%20实现浏览出租房搜索/代码/house/src/main/webapp/css/style.css">
<META name=GENERATOR content="MSHTML 8.00.7601.17514">
  <script language="JavaScript" src="../../../../../../每日文件/U4/U4=Day12%20实现浏览出租房搜索/代码/house/src/main/webapp/admin/js/jquery-1.8.3.js"></script>
...
<DIV id=header class=wrap>
  <DIV id=logo><IMG src="../../../../../../每日文件/U4/U4=Day12%20实现浏览出租房搜索/代码/house/src/main/webapp/images/logo.gif"></DIV>
...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><INPUT id=add_action_title class=text type=text value="${house.title}" name=title> </TD></TR>
  <TR>
...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD>
      <img src="http://localhost:81/${house.path}?a=<%=Math.random()%>" width="100" height="100"/>
